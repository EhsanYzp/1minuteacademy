-- Revert awarding: Minute Expert minutes + badges are Pro-only.
--
-- This defines the same RPC signatures used by the app and restores the
-- original awarding rule: +1 only for Pro users who are not paused.
